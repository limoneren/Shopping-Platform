...
<div class="signuppart">
	...
	<div class=formcontainer>
		...
		<form class="signupform" action="signupaction.php" method="post">
...
<ul>
	...
	<li><select name="membership_type" required="required">
	...
	<button type="submit" class="btn btn-primary btn-block btn-large" name="signupbutton">Sign Up as a Customer!</button>
