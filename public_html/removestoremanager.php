...
<div class="signuppart">
	...
	<div class=formcontainer>
		...
		<form class="signupform" action="removestoremanageraction.php" method="post">
...
<ul>
	...
	<button type="submit" class="btn btn-primary btn-block btn-large" name="signupbutton">Remove Store Manager</button>
